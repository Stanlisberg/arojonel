...
function Navbar() {
  return (
    <nav className="bg-[#D6DED3] w-full">
    <div className="max-w-[1140px] m-auto flex justify-between items-center px-4 sm:px-5 py-3">
      <div className='flex justify-between items-center'>
        ...
        <ul className="hidden lg:flex text-[15px] ml-20 cursor-pointer">
          <li className="px-6 py-[4px] hover:bg-neutral-500 hover:text-white hover:rounded-[10px] mx-[1px] text-[#2A2A2A]">
            Home
          </li>
          <li className="px-6 py-[4px] hover:bg-neutral-500 hover:text-white hover:rounded-[10px] mx-[1px] text-[#2A2A2A]">
            About
      ...
      <div className="flex justify-between items-center">
        <div className="w-[200px] hidden sm:flex relative border border-black mr-[40px] rounded-[15px] py-[2px] text-zinc-950 text-opacity-25 text-[13px]">
          ...
          <input
            type="text"
            className="h-7 w-[150px] ml-[30px] bg-[#D6DED3] text-[11px] outline-none pl-2 rounded-[10px] placeholder:text-[13px] placeholder:text-slate-400 text-slate-500 font-medium block sm:text-[12px]"
