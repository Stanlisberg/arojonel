      ...
      <div className="max-w-[1140px] m-auto flex justify-between items-center px-4 sm:px-5 py-3">
        <div className="flex justify-between items-center">
          ...
          <ul className="hidden lg:flex text-[15px] ml-20 cursor-pointer m-auto">
            <Link href="/">
              <li className={`${pathname.startsWith('/') ? 'border-b border-[#F9BF29] text-white opacity-100 mx-2 px-3 ' : 'opacity-60 px-3 text-white hover:text-white hover:border-b hover:border-[#F9BF29] hover:opacity-100   mx-2'}`}>
                Home
              </li>
            </Link>
            <Link href="/about">
              <li className={`${pathname.startsWith('/about') ? 'border-b border-[#F9BF29] text-white opacity-100 px-3 mx-2' : 'opacity-60 px-3 text-white hover:text-white hover:border-b hover:border-[#F9BF29] hover:opacity-100  mx-2'}`}>
                About
              </li>
            </Link>
            <Link href="/help">
              <li className={`${pathname.startsWith('/help') ? 'border-b border-[#F9BF29] text-white opacity-100 px-3 mx-2' : 'opacity-60 px-3 text-white hover:text-white hover:border-b hover:border-[#F9BF29] hover:opacity-100  mx-2'}`}>
                Help
              </li>
            </Link>
            <Link href="/contact">
              <li className={`${pathname.startsWith('/contact') ? 'border-b border-[#F9BF29] text-white opacity-100 px-3 mx-2' : 'opacity-60 px-3 text-white hover:text-white hover:border-b hover:border-[#F9BF29] hover:opacity-100 mx-2'}`}>
                Contact
              </li>
            </Link>
